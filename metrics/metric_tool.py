...
# NOTE: These metrics are used for comparison with other models published in other papers,
#       to get a fair comparison we use the exact same metric implementtation
#       taken from the following origin:
#       https://github.com/justchenhao/BIT_CD, https://github.com/wgcban/ChangeFormer
